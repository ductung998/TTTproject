...
{
    public partial class Hoatchatgoc : Form
    {
        public Hoatchatgoc()
        {
            InitializeComponent();
        ...
        {
            dataGridView1.DataSource = taikhoan.Loadhoatchatgoc();
            // wrap text
        ...
        {
            bool tontai = false;
            foreach (hoatchatgoc item in taikhoan.Loadhoatchatgoc())
            {
            ...
            {
                taikhoan.Themhoatchatgoc(textBox1.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                taikhoan.Capnhathoatchatgoc(tencu, tenmoi);
            }
            loaddata();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    taikhoan.Xoahoatchatgoc(tenxoa);
