...
{
    public partial class KhoaLS : Form
    {
        public KhoaLS()
        {
            InitializeComponent();
        ...
        {
            dataGridView1.DataSource = taikhoan.Loadkhoa();
            // wrap text
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                taikhoan.Themkhoa(textBox1.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                taikhoan.Capnhatkhoa(tencu, tenmoi);
            }
            loaddata();
        }
